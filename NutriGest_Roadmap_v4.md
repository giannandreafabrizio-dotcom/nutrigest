...
### P151 — Chiave primaria senza `user_id` su 4 tabelle: debito che scade quando vendi 🔵 DA FARE
...
**SCHEDA:** Stato: 🔵 Da fare · Priorità: Media (Alta se si avvicina la vendita) · Categoria: Backend / Supabase · Dipendenze: nessuna · Complessità 2 · Impatto 4 · Rischio 4 · Autonomia LLM: **L0**

### P152 — `updated_at` di due tipi diversi: fragilità latente, non bug 🔵 DA FARE
...
**SCHEDA:** Stato: 🔵 Da fare · Priorità: Bassa · Categoria: Backend / Supabase · Dipendenze: conviene accorparla a P151 · Complessità 1 · Impatto 2 · Rischio 3 · Autonomia LLM: **L0**

### P154 — Le policy RLS rivalutano `auth.uid()` a ogni riga: terzo debito che scade quando vendi 🔵 DA FARE
...
**SCHEDA:** Stato: 🔵 Da fare · Priorità: **Bassa oggi, Media vicino alla vendita** · Categoria: Backend / Supabase · Dipendenze: **da accorpare a P151+P152** · Complessità 1 | Impatto 2 | Rischio 4 (è DDL in produzione) · Autonomia LLM: **L0** — nessuna scrittura di iniziativa, mai.
