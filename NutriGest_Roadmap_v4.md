...
**SCHEDA:** Stato: **IMPLEMENTATA, da collaudare** ⚠️ 28 lug 2026 · Test 410/410 · **Il collaudo è il primo referto importato davvero**: la tappa 1 non è mai passata per una chiamata AI reale. Se l'estrazione degli intervalli fallisce, il grafico semplicemente non compare — nessun danno agli altri.
**DA VERIFICARE AL PRIMO IMPORT:** che `riferimenti` arrivi popolato; che i valori corrispondano a quelli stampati; che su un referto di un'altra macchina (senza intervalli) non succeda niente di strano.
