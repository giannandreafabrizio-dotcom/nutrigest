...
**SCHEDA:** Stato: **CHIUSA, da collaudare** · Priorità: Alta · Categoria: Sicurezza clinica / Import AI · Modello: Opus · Autonomia: L1 · Test 305 → **318** (`s2-import-referto-controlli.test.js`). Estende P63 (staging + diff) e P118 (referti datati, range del laboratorio), che restano invariate.
