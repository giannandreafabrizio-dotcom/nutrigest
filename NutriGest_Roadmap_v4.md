...
**RESTA APERTO:** la **parte 2** (obiettivo peso, giorni di carico, ciclizzazione carboidrati, cronotipo, orario pasto principale) — stessa richiesta, stesso motivo. Nota nata qui: le righe attività sanno quante sedute fa il paziente, quindi la coerenza fra sedute dichiarate e giorni ON spuntati a mano diventa verificabile.
