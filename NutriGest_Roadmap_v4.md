...
### P157 — La sync spingeva tutto PRIMA di idratare: il difetto che ha sovrascritto sei pazienti 🟡 CHIUSA IN CODICE 12 ago 2026 — COLLAUDO SUL CAMPO DA FARE
...
**FINCHE IL COLLAUDO SUL CAMPO NON E FATTO:** restano in vigore le regole operative dell'11 agosto — una sola scheda, un solo dispositivo — e la tabella `_pre_ripristino_20260811` non si elimina.
**LE QUATTRO PROVE DA FARE** (scritte qui perche' senza il "cosa guardare" una voce resta ferma una settimana — lezione di P147): (1) all'avvio la console deve dire «nessuna modifica locale in attesa: nessun push»; (2) modifica su iPhone -> sync sul PC: la scheda si **riscarica** senza chiedere niente; (3) stesso paziente modificato su entrambi senza sincronizzare -> deve comparire il dialogo a tre vie; (4) «Riscarica tutto dal cloud» e conteggi referti ancora corretti.
