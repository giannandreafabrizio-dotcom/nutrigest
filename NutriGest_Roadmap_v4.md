...
2. **Proiezione ibrida** — cono futuro che parte dal calo teorico del deficit prescritto (7700 kcal/kg SOLO come innesco) e si ricalibra sul TDEE osservato (P114 passo 4) man mano che arrivano pesate; si piega sulle fasi pianificate e si allarga col tempo. Sostituisce la data secca di `calcolaMacros`.
...
**SCHEDA:** Stato: **In corso** (Tappa 1 ✅ 24 lug, da collaudare in produzione da Fabrizio · Tappe 2-5 da fare in sessioni dedicate, una per volta) · Priorità: Media · Categoria: Motore clinico / UI · Dipendenze: nessuna per Tappe 2-4; la Tappa 5 si completa solo con P50 · Modello: Fable/Opus (High) per proiezione e formule, anche Sonnet per UI · Autonomia: L1 con test verdi prima/dopo e approvazione di Fabrizio a ogni tappa · Origine: evoluzione di P114 passo 9, sessione di design 24 lug 2026.
