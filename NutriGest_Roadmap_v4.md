...
5. **Slot consuntivo (predisposizione)** — struttura dati e spazio visivo per il livello "Piano vs Realtà" (aderenza giornaliera, kcal extra sgarri, ritardo accumulato = extra÷7700, settimane perse) che si accenderà con l'app paziente (P50). Non si costruisce l'acquisizione dati ora.
**FOCUS COMPONENTI COINVOLTI:** scheda paziente (nuova linguetta + pannello, righe ~6020-6280), riuso `_serieePesoOss`/`calcolaTDEE`/`calcolaTDEEOsservato`. Dati: nuovo campo `p.percorso` nel blob paziente (sync invariato).
**SCHEDA:** Stato: **In corso** (Tappe 1-2-3-4 ✅ 24 lug — da collaudare in produzione da Fabrizio · Tappa 5 da fare) · Priorità: Media · Categoria: Motore clinico / UI · Dipendenze: la Tappa 5 si completa solo con P50 · Modello: Fable/Opus (High) per la Tappa 5 · Autonomia: L1 con test verdi prima/dopo e approvazione di Fabrizio a ogni tappa · Origine: evoluzione di P114 passo 9, sessione di design 24 lug 2026.
