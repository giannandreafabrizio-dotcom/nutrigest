...
3. **Corsia energia** — introito prescritto (da `macrosStorico`) + TDEE stimato + TDEE osservato sotto il grafico peso, asse kcal separato.
...
**SCHEDA:** Stato: **In corso** (Tappa 1 ✅ 24 lug · Tappa 2 ✅ 24 lug — entrambe da collaudare in produzione da Fabrizio · Tappe 3-5 da fare in sessioni dedicate, una per volta) · Priorità: Media · Categoria: Motore clinico / UI · Dipendenze: nessuna per Tappe 3-4; la Tappa 5 si completa solo con P50 · Modello: Fable/Opus (High) per proiezione e formule, anche Sonnet per UI · Autonomia: L1 con test verdi prima/dopo e approvazione di Fabrizio a ogni tappa · Origine: evoluzione di P114 passo 9, sessione di design 24 lug 2026.
