...
**SCHEDA:** Stato: Da fare · Priorità: Media-alta (Fabrizio lo usa già in visita) · C: 3 | I: 3 | R: 2 (senza gli intervalli veri il grafico non ha basi) · Modello: Fable (Alto) per l'estrazione · Autonomia: L0 (serve un referto reale per collaudare l'import).
