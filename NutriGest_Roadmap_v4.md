...
4. **Composizione + interruttori** — linea massa magra (stesso asse kg; il divario col peso È la massa grassa), % grasso nel tooltip, interruttori per accendere/spegnere gli strati (default tecnico per Fabrizio, versione pulita da mostrare al paziente).
...
**SCHEDA:** Stato: **In corso** (Tappe 1-2-3 ✅ 24 lug — da collaudare in produzione da Fabrizio · Tappe 4-5 da fare, una per volta) · Priorità: Media · Categoria: Motore clinico / UI · Dipendenze: nessuna per la Tappa 4; la Tappa 5 si completa solo con P50 · Modello: Fable/Opus (High) per proiezione e formule, anche Sonnet per UI · Autonomia: L1 con test verdi prima/dopo e approvazione di Fabrizio a ogni tappa · Origine: evoluzione di P114 passo 9, sessione di design 24 lug 2026.
