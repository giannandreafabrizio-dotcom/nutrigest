...
- **File principale**: `index.html` (unico file HTML self-contained, **32.616 righe** al 12 ago 2026 — questo numero si ricontrolla con `wc -l`, non si copia)
...
| `NutriGest_Incidente_Sync_11ago_e_P157.md` | ⚠️ **RIGA AGGIUNTA IL 12 AGO 2026 — il documento è nato l'11 e la tabella non lo conosceva: seconda occorrenza consecutiva dello stesso difetto** (dopo `Connettori_Analisi`), che è il motivo per cui la Regola 23 punto 7 esiste. È il **verbale dell'incidente dell'11 agosto** (sei pazienti sovrascritti, recuperati dal backup del 9). Porta in testa un riquadro del 12 ago: il §4 («P157 aperta») e il §6 punti 1-2 sono **storia** — P157 è chiusa in codice — mentre il **§5 resta interamente in vigore** finché il collaudo sul campo non è fatto (una sola scheda, un solo dispositivo, `_pre_ripristino_20260811` non si tocca). I §1 e §3 (fatti e log) non invecchiano. |
