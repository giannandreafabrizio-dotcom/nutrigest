...
| `NutriGest_TDEE_Parte1_Ragionamento.md` | ⚠️ **Riverificato il 10 ago 2026.** «Nessuna modifica al codice è stata fatta» resta **falso** (P147 chiusa, `77649f0`), e il catalogo del §6 propone 78 voci mentre `_MET_CATALOGO` ne ha **117 — tutte e 117 col codice Compendium a 5 cifre accanto**, cioè la regola 20 applicata al 100%. Si tiene per il *perché* del motore MET additivo. |
